...
all_tinyCheck* get_all_tinyCheckData() {
	...
	if (local_CheckData->Login_code == 0) {
    	local_CheckData->Login_code = 11570;
     	snprintf(local_CheckData->APPID, sizeof(local_CheckData->APPID), "%d", 81341);
     	snprintf(local_CheckData->APPKEY, sizeof(local_CheckData->APPKEY), "%s", "e34079faf78e1d85e70bfa64930bf4d8");
    	snprintf(local_CheckData->RC4KEY, sizeof(local_CheckData->RC4KEY), "%s", "r91d85c22f82bfc07561acfff8ee58e5a");	
    }
